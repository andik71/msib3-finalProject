            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown"> 
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item"> <a href="#"> <img src="assets/img/messages-2.jpg"
                        ...
                        <li class="message-item"> <a href="#"> <img src="assets/img/messages-3.jpg"
                                    alt="" class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src=" {{ url('/public/assets/img') }}/{{ Auth::user()->photo }}" alt="Profile"
                            class="rounded-circle">
                        @else
                        <img src=" {{ url('/public/assets/img/default.png') }}" alt="Profile"
                        class="rounded-circle">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            ...
                            href="{{ url('admin/user/profile', Auth::user()->id) }}">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" 
                        href="{{ url('admin/user/edit-profile', Auth::user()->id) }}">
